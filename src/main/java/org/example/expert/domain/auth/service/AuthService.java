...
import org.example.expert.domain.auth.dto.response.JwtTokenResponseDto;
...
public class AuthService {
    ...
    @Cacheable(cacheNames = "loginUser", key = "'login'+ #p0.getEmail()", unless = "#result== null")
    @Transactional
    public JwtTokenResponseDto signin(SigninRequest signinRequest) {
        ...
        return new JwtTokenResponseDto(bearerToken);
    }
}
